        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <p class="list-group-item list-group-item-action"/><i class="fa fa-user-plus"></i><a href="index.php?page=add-student"> Add Student</a>
              <p class="list-group-item list-group-item-action"/><i class="fa fa-users"></i><a href="index.php?page=all-student"> All Students</a>
              <p class="list-group-item list-group-item-action"/><i class="fa fa-users"></i><a href="index.php?page=all-users">All Users</a>
              <p class="list-group-item list-group-item-action"><i class="fa fa-user"></i><a href="index.php?page=user-profile"> User Profile</a>
            </div>
          </div>
          <div class="col-md-9">
             <div class="content">
