		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
		    	...
		    	<option value="1st" <?= $row['class']=='1st'? 'selected':'' ?>>ENGG</option>
		    	<option value="2nd" <?= $row['class']=='2nd'? 'selected':'' ?>>PHARMACY</option>
		    	<option value="3rd" <?= $row['class']=='3rd'? 'selected':'' ?>>BCA</option>
		    	<option value="4th" <?= $row['class']=='4th'? 'selected':'' ?>>BSC</option>
		    	<option value="5th" <?= $row['class']=='5th'? 'selected':'' ?>>ITI</option>
		    </select>
	  	</div>
	  	<div class="form-group">
