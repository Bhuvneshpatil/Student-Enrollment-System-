...
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Add New Student <small class="text-warning"></small></h1>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="roll"type="text" value="<?= isset($roll)? $roll: '' ; ?>" class="form-control" pattern="[0-9]{6}" maxlength="4" onkeypress="return event.charCode>=48 && event.charCode<=57" pattern="01[5|6|7|8|9][0-9]{8}"  id="roll" required="">
	  	</div>
	  	<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" maxlength="10" onkeypress="return event.charCode>=48 && event.charCode<=57" pattern="01[5|6|7|8|9][0-9]{8}" value="<?= isset($pcontact)? $pcontact: '' ; ?>"required="">
	  	</div>
	  	<div class="form-group">
		    <label for="class">Student Class</label>
		    <select name="class" class="form-control" id="class" required="">
		    	<option>Select</option>
		    	<option value="1st">ENGG</option>
		    	<option value="2nd">BCA</option>
		    	<option value="3rd">PHARMACY</option>
		    	<option value="4th">BSC</option>
		    	<option value="5th">ITI</option>
		    </select>
	  	</div>
	  	<div class="form-group">
