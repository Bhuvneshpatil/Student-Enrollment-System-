     ...
     <div class="card text-white bg-info mb-3">
      ...
      <div class="list-group-item-primary list-group-item list-group-item-action"> 
        <div class="row">
          ...
          <div class="col-sm-4">
          <a href="index.php?page=all-users"><i class="fa fa-arrow-right float-sm-right"></i>
          </div>
        </div>
        </a>
      </div>
     ...
     <div class="card text-white bg-warning mb-3">
      ...
      <div class="list-group-item-primary list-group-item list-group-item-action">
        <div class="row">
          ...
          <div class="col-sm-4">
            <a href="index.php?page=user-profile"><i class="fa fa-arrow-right float-sm-right"></i>
          </div>
        </div>
        </a>
      </div>
