...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          <h1 class="text-center" style="color:blue">Register Users!</h1><hr><br>
            ...
            <div class="col-md-8 offset-md-2">
             	<form method="POST" enctype="multipart/form-data">
				  <div class="form-group row">
				    <div class="col-sm-6">
				      <input type="text" class="form-control" value="<?= isset($name)? $name:'' ?>" name="name" placeholder="FullName" id="inputEmail3"><?= isset($input_error['name'])? '<label for="inputEmail3" class="error">'.$input_error['name'].'</label>':'';  ?>
				    </div>
				    <div class="col-sm-6">
              ...
              <center><p>If you have account, you can <a href="login.php"><b>Login</b></a> your account!</p></center>
    </div>
    <footer>
    	<p style="color:white;" align="Right"><b>Copyright &copy; bhuvnesh_exe_24______</b><?php //echo date('Y') ?></p>
    </footer>
    <!-- Optional JavaScript -->
